...
<head>
    ...
    <script defer src="search.js?v=2"></script>
</head>
<body>
    ...
    <main class="page-container">
        ...
        <h3>Users</h3>
        <div id="users-result">Type something and search.</div>

        <h3>Posts</h3>
        <div id="posts-result">Type something and search.</div>
    </main>
